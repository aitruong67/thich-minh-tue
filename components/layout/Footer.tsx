        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-white/8 pt-8 mb-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <span className="font-ui text-[0.6rem] uppercase tracking-[0.14em] text-white/25">Follow</span>
              ...
              <a href="https://www.change.org/TMTWalk4Peace" target="_blank" rel="noopener noreferrer" aria-label="Sign the petition"
                className="font-ui text-[0.6rem] uppercase tracking-[0.12em] text-saffron/60 hover:text-saffron transition-colors border border-saffron/20 hover:border-saffron/50 px-3 py-1 rounded-full ml-2">
                ✍ Sign petition
              </a>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-2">
            ...
            <p className="font-ui text-[0.6rem] text-white/15 uppercase tracking-[0.12em]">
